 ...
 *
 * A button at the bottom launches [MainActivity] pre-set to [AnalysisMode.ODOMETRY_UNIFIED]
        ...
        findViewById<Button>(R.id.btnLaunchOdometry).setOnClickListener {
            startActivity(
                Intent(this, MainActivity::class.java).apply {
                    putExtra(MenuActivity.EXTRA_MODE, AnalysisMode.ODOMETRY_UNIFIED.name)
                }
            )
        }
    }
