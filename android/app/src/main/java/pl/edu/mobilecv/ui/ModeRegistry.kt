...
object ModeRegistry {
    ...
    private val modeEntries: Map<AnalysisMode, ModeEntry> = listOf(
        ...
        ModeEntry(AnalysisMode.RTMDET, FunctionalGroup.DETECTION, R.string.mode_desc_rtmdet, AnalysisMode.RTMDET.filters),
        ModeEntry(AnalysisMode.MOBILINT, FunctionalGroup.DETECTION, R.string.mode_desc_mobilint, AnalysisMode.MOBILINT.filters),
        ModeEntry(AnalysisMode.TFLITE, FunctionalGroup.DETECTION, R.string.mode_desc_tflite, AnalysisMode.TFLITE.filters),
        ModeEntry(AnalysisMode.POSE, FunctionalGroup.DETECTION, R.string.mode_desc_pose, AnalysisMode.POSE.filters),
        ModeEntry(AnalysisMode.TRACKING, FunctionalGroup.DETECTION, R.string.mode_desc_tracking, AnalysisMode.TRACKING.filters),
        ModeEntry(AnalysisMode.ODOMETRY, FunctionalGroup.ANALYSIS, R.string.mode_desc_odometry, AnalysisMode.ODOMETRY.filters),
        ModeEntry(AnalysisMode.FULL_ODOMETRY_3D, FunctionalGroup.ANALYSIS, R.string.mode_desc_full_odometry_3d, AnalysisMode.FULL_ODOMETRY_3D.filters),
        ModeEntry(AnalysisMode.GEOMETRY, FunctionalGroup.ANALYSIS, R.string.mode_desc_geometry, AnalysisMode.GEOMETRY.filters),
    ...
    private val filterDescriptionResIds: Map<OpenCvFilter, Int> = mapOf(
        ...
        OpenCvFilter.POINT_CLOUD to R.string.filter_desc_point_cloud,
        OpenCvFilter.PLANE_DETECTION to R.string.filter_desc_plane_detection,
        OpenCvFilter.VANISHING_POINTS to R.string.filter_desc_vanishing_points,
        ...
        OpenCvFilter.RTMDET_DETECT to R.string.filter_desc_rtmdet_detect,
        OpenCvFilter.RTMDET_ROTATED to R.string.filter_desc_rtmdet_rotated,
        OpenCvFilter.TFLITE_DETECT to R.string.filter_desc_tflite_detect,
